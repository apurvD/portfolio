    ...
    <main className="pt-20">
      <section className="section-container">
        <div className="card">
          ...
          <img src="/src/images/fringe_home.png" alt="Fringe Benefits" className="project-image my-4" />
          ...
          <div className="my-4">
            <img src="/src/images/fringe_home.png" alt="Fringe Home" className="project-image" />
          </div>
