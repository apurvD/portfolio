    ...
    <main className="pt-20">
      <section className="section-container">
        <div className="card">
          ...
          <img src="/src/images/nlp_home.png" alt="NLP" className="project-image my-4" />
          ...
          <div className="my-4">
            <video controls className="w-full max-w-3xl">
              <source src="/src/projects/Deployment_NWP.mp4" type="video/mp4" />
            </video>
            <h4 className="mt-2">Project Demo</h4>
          </div>

          <div className="grid gap-4">
            <img src="/src/images/nlp_EDA1.png" alt="EDA 1" className="project-image" />
            <img src="/src/images/nlp_EDA2.png" alt="EDA 2" className="project-image" />
            <img src="/src/images/nlp_dataset.png" alt="Dataset" className="project-image" />
          </div>
